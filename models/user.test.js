...
describe("/:username/jobs/:id", function () {
  // Test case: should apply for a job successfully
  test("works", async function () {
  ...
  // Test case: should throw BadRequestError when attempting to apply for a job with non-existing username
  ...
  // Test case: should throw BadRequestError when attempting to apply for a job with non-existing job ID
