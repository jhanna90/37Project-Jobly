...
/* Supports creating SQL/pg query statements by accepting data and manually entering column names as parameters. Used to update companies and users tables.
- dataToUpdate parameter specifies data to be updated (via request body)as a set of key/value pairs
